...
import { Users, UserCheck, Search, MoreHorizontal, Eye, Edit, Download, RefreshCw, Calendar, DollarSign, TrendingUp, Phone, Mail, MessageSquare } from "lucide-react"
...
import { usePaginatedCustomers, useCustomerStats } from "@/hooks/use-customers"
...
export default function CustomersPage() {
  ...
  const { data: stats } = useCustomerStats(studioId || '')
  ...
  const sendWhatsAppMessage = (phone: string, customerName: string) => {
    ...
    const message = `Hello ${customerName}, this is customer service from our studio. How can we help you today?`
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem
                              onClick={() => sendWhatsAppMessage(customer.phone, customer.full_name)}
                            >
