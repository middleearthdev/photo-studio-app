...
const mockCategories: PackageCategory[] = [
  {
    id: "123e4567-e89b-12d3-a456-426614174001",
    studio_id: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    name: "Portrait Packages",
    description: "Paket foto portrait untuk berbagai kebutuhan",
    display_order: 1,
    is_active: true,
    package_count: 3,
  ...
  },
  {
    ...
    description: "Paket foto pre-wedding dan pernikahan",
    display_order: 2,
    is_active: true,
    package_count: 2,
    created_at: "2025-01-15T10:00:00Z"
  },
  {
    ...
    description: "Paket foto untuk kebutuhan komersial dan bisnis",
    display_order: 3,
    is_active: true,
    package_count: 2,
    created_at: "2025-01-15T10:00:00Z"
  },
  {
    ...
    description: "Paket spesial dan bundle hemat",
    display_order: 4,
    is_active: true,
    package_count: 2,
    created_at: "2025-01-15T10:00:00Z"
...
export default function PackageCategoriesPage() {
  const [categories, setCategories] = useState<PackageCategory[]>(mockCategories)
    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage categories for organizing your photography packages
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {categories.reduce((acc, cat) => acc + cat.package_count, 0)}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage and organize your photography package categories
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                This action cannot be undone and will affect {category.package_count} packages.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingCategory 
                ...
                : "Create a new package category to organize your services."
              }
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., Portrait Packages, Wedding Packages"
              />
            </div>
