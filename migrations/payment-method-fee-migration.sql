...
-- If fee_percentage > 0, keep as percentage, otherwise we'll need to set manually
UPDATE payment_methods 
SET fee_type = 'percentage' 
WHERE fee_percentage > 0;

-- For payment methods with 0 fee_percentage, we'll leave fee_type as 'percentage' by default
-- but they can be updated to 'fixed' and fee_amount can be set manually
